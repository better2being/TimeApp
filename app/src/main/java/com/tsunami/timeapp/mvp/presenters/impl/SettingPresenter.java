...
import com.tsunami.timeapp.ui.PayActivity;
import com.tsunami.timeapp.utils.EverNoteUtils;
import com.tsunami.timeapp.utils.FileUtils;
import com.tsunami.timeapp.utils.NotesLog;
import com.tsunami.timeapp.utils.ObservableUtils;
import com.tsunami.timeapp.utils.PermissionRequester;
...
public class SettingPresenter implements Presenter, DialogInterface.OnClickListener{
    ...
    // 2 关于意见反馈功能，此应用只是简单使用了发送邮件作为反馈方式
    private void initFeedbackPreference(){
        Uri uri = Uri.parse("mailto:2010330579@qq.com");
    ...
    // 2 打开应用商店搜索此应用，便于用户对此应用评分
    private void giveFavor(){
        try{
            Uri uri = Uri.parse("market://details?id="+ "QQ");
