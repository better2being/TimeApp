package com.tsunami.timeapp.Activity3.GesturePassword.widget;
...
import com.tsunami.timeapp.Activity3.GesturePassword.common.AppUtil;
import com.tsunami.timeapp.Activity3.GesturePassword.common.Constants;
import com.tsunami.timeapp.Activity3.GesturePassword.entity.GesturePoint;
...
public class GestureDrawline extends View {
	...
	public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
		...
		paint.setStrokeWidth(5);// 笔宽5像素 ZLF
	...
	private void drawErrorPathTip() {
		canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);
		paint.setColor(Color.rgb(70, 40, 37));// 设置默认线路颜色
		for (Pair<GesturePoint, GesturePoint> pair : lineList) {
