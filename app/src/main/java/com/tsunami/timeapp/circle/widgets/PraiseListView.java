package com.tsunami.timeapp.circle.widgets;
...
import com.tsunami.timeapp.circle.spannable.CircleMovementMethod;
import com.tsunami.timeapp.circle.spannable.SpannableClickable;
...
public class PraiseListView extends TextView{
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(MyXutils.getContext(), R.drawable.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
