package com.tsunami.timeapp.circle.adapter;
...
import com.tsunami.timeapp.activity1.ImagePagerActivity;
...
import com.tsunami.timeapp.circle.bean.ActionItem;
...
import com.tsunami.timeapp.circle.widgets.CircleVideoView;
import com.tsunami.timeapp.circle.widgets.CommentListView;
import com.tsunami.timeapp.circle.widgets.MultiImageView;
import com.tsunami.timeapp.circle.widgets.PraiseListView;
import com.tsunami.timeapp.circle.widgets.SnsPopupWindow;
import com.tsunami.timeapp.circle.widgets.dialog.CommentDialog;
                ...
                if(hasFavort){//处理点赞列表
                    holder.praiseListView.setOnItemClickListener(new PraiseListView.OnItemClickListener() {
                        ...
                        public void onClick(int position) {
                            ...
                            Toast.makeText(MyXutils.getContext(), userName + " &id = " + userId, Toast.LENGTH_SHORT).show();
                        }
                    });
