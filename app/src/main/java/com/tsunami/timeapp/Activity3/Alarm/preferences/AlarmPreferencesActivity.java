...
import com.tsunami.timeapp.Activity3.Alarm.BaseActivity;
import com.tsunami.timeapp.R;
import com.tsunami.timeapp.Activity3.Alarm.database.Database;
import com.tsunami.timeapp.Activity3.Alarm.preferences.AlarmPreference.Key;
/**
 * @author zhenglifeng
 */
...
//		actionBar.setDisplayHomeAsUpEnabled(true);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			case android.R.id.home:
				setIntent(new Intent(AlarmPreferencesActivity.this, AlarmActivity.class));
	...
	//方法：控件View的点击事件
	public void onClickClockPreferencesBack(View v) {
//		Intent intent = new Intent(AlarmPreferencesActivity.this, AlarmActivity.class);
//		startActivity(intent);
		finish();
	}

	//方法：控件View的点击事件
	public void onClickClockPreferencesSave(View v) {
		Database.init(getApplicationContext());
		if (getMathAlarm().getId() < 1) {
			Database.create(getMathAlarm());
		} else {
	...
	//方法：控件View的点击事件
	public void onClickClockPreferencesDelete(View v) {
		AlertDialog.Builder dialog = new AlertDialog.Builder(AlarmPreferencesActivity.this);
		dialog.setTitle("Delete");
		dialog.setMessage("Delete this alarm?");
		dialog.setPositiveButton("Ok", new OnClickListener() {
