package com.tsunami.timeapp.Activity3.Shortcut;
...
public class Shortcut extends AppCompatActivity {
    ...
    public void addShortcutTest(View view) {
        ...
        if (!ShortcutSuperUtils.isShortCutExist(this, mShortcutName, getShortCutIntent())) {
            ShortcutUtils.addShortcut(this, getShortCutIntent(), mShortcutName, false,
                    BitmapFactory.decodeResource(getResources(), R.drawable.ocsplayer));
            finish();
        } else {
    ...
    private Intent getShortCutIntent() {
        ...
        intent.setClass(Shortcut.this, ShortcutActivity.class);
        return intent;
    }
