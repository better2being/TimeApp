...
//		actionBar.setDisplayHomeAsUpEnabled(true);
		...
		// 2 长按AlarmListView弹出删除该闹钟的dialog
...
//				setIntent(new Intent(AlarmActivity.this, MainActivity.class));
...
//		startActivity(intent);
	...
	//方法：控件View的点击事件
	public void onClickClockBack(View v) {
		AlarmActivity.this.finish();
	}

	//方法：控件View的点击事件
	public void onClickClockMenu(View v) {
		Intent intent = new Intent(AlarmActivity.this, AlarmPreferencesActivity.class);
		startActivity(intent);
