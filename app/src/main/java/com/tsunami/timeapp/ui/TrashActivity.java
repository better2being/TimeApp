...
import com.tsunami.timeapp.mvp.presenters.impl.TrashPresenter;
 ...
 * @author wangshujie
 */
public class TrashActivity extends BaseActivity implements MainView{
    ...
    @Inject TrashPresenter trashPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializePresenter();
        trashPresenter.onCreate(savedInstanceState);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        trashPresenter.onSaveInstanceState(outState);
    }

    @Override
    public void onStart() {
        super.onStart();
        trashPresenter.onStart();
    }

    @Override
    protected void onResume() {
        super.onResume();
        trashPresenter.onResume();
    }

    @Override
    protected void onPause() {
        trashPresenter.onPause();
        super.onPause();
    }
    ...
    public void initRecyclerView(List<SNote> notes){
        ...
        recyclerAdapter.setOnInViewClickListener(R.id.notes_item_root,
                new BaseRecyclerViewAdapter.onInternalClickListenerImpl<SNote>() {
                    ...
                    public void OnClickListener(View parentV, View v, Integer position, SNote values) {
                        ...
                        trashPresenter.onRecyclerViewItemClick(position, values);
                    }
                });
        recyclerAdapter.setOnInViewClickListener(R.id.note_more,
                new BaseRecyclerViewAdapter.onInternalClickListenerImpl<SNote>() {
                    ...
                    public void OnClickListener(View parentV, View v, Integer position, SNote values) {
                        super.OnClickListener(parentV, v, position, values);
                        trashPresenter.showPopMenu(v, position, values);
                    }
                });
        ...
        refreshLayout.setOnRefreshListener(trashPresenter);
    }
...
//    }
    ...
    public void showNormalPopupMenu(View view, SNote note) {
        ...
        popup.setOnMenuItemClickListener((item -> trashPresenter.onPopupMenuClick(item.getItemId(), note)));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItemCompat.setOnActionExpandListener(searchItem, trashPresenter);
        return true;
    }
...
//        }
         ...
         * 2 添加的代码
         */
        trashPresenter.onOptionsItemSelected(item.getItemId());
        //////////////////////////////////////////////////////
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        return trashPresenter.onKeyDown(keyCode) || super.onKeyDown(keyCode, event);
    }

    @OnClick(R.id.fab)
    public void newNote(View view){
        trashPresenter.newNote();
    }
    ...
    public void showDeleteForeverDialog(final SNote note){
        ...
        DialogInterface.OnClickListener listener = (DialogInterface dialog, int which) ->
                trashPresenter.onDeleteForeverDialogClick(note, which);
