 ...
 * @author shenxiaoming
 */
public class NotePresenter extends AppCompatActivity implements Presenter, android.view.View.OnFocusChangeListener,
...
//                return true;
    ...
    private void startWeatherDetialActivity() {
        ...
        Log.e("fileStream", ", ,,,,," + FileStreamUtil.load(mContext));
        if (TextUtils.isEmpty(FileStreamUtil.load(mContext))) {
            // 获取当前网络状态
...
//            PermissionsManager.getInstance().requestPermissionsIfNecessaryForResult(NotePresenter.this,
//                    new String[]{Manifest.permission.CAMERA}, new PermissionsResultAction() {
//
//                        @Override
//                        public void onGranted() {
//                            Log.e("dfsfsf", "onGranted: Read Contacts");
//
//                        }
//
//                        @Override
//                        public void onDenied(String permission) {
//                            Log.e("dsfsfs", "onDenied: Read Contacts");
//
//
//                        }
//                    }
//            );
        ...
        timer.schedule(task, 1000); // 1秒后跳转
    ...
    public void sendNoteToDesk() {
        ...
        if (!ShortcutSuperUtils.isShortCutExist(mContext, note.getLabel(), getShortCutIntent())) {
            ShortcutUtils.addShortcut(mContext, getShortCutIntent(), note.getLabel(), false,
                    BitmapFactory.decodeResource(mContext.getResources(), R.drawable.time_note));
